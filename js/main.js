...
option elements are removed or deleted essentially...*/
	...
	$($('#design')).on('change', function() {
		...
		if (design.value === 'js puns') {
			...
			$('#color').append(
				'<option class="heartJsColors" value="dimgrey">Dim Grey (I &#9829; JS shirt only)</option>'
			);
...
====================================================================*/
	...
	$('.activities').append(
		'<div class="totalDiv"><label name="total-amount" class="total-display">Total: </label></div>'
	);
...
}); //conclusion of DOM Content Loaded Function
